      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
         child: FutureBuilder<DocumentSnapshot>(
           future: EcommerceApp.firestore.collection('items').document(widget.itemID).get(),
           builder: (c, snapshot){
             ...
             return snapshot.hasData? SingleChildScrollView(
               child: Column(
                 children: [
                   Container( margin: EdgeInsets.only(top: 20.0 ), child: Text("UPDATE ITEM", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 26),)),
                   Center(
                     child: Container(
                       height: 230.0,
                           ...
                           child: Container(
                             decoration: BoxDecoration(
                                 image: DecorationImage(
                                     image: !imageUpdated ?NetworkImage(dataMap['thumbnailUrl']) : FileImage(file), fit: BoxFit.cover)),
                           ),
                         ),
                       ),
                     ),
                         ...
                         children: [
                           ...
                           Container(
                             ...
                             child: DropdownButton<String>(
                               value: _category!=null?_category:dataMap['category'],
                               //elevation: 5,
                           ...
                           longDescriptionField(dataMap['longDescription']),
                           SizedBox(
                             height: 16,
                           ),
